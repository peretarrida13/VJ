...
void Scene::init()
{
	...
	texCoords[0] = glm::vec2(0.f, 1.f); texCoords[1] = glm::vec2(0.5f, 0.5f);
...
void Scene::render()
{
	...
	modelview = glm::scale(modelview, glm::vec3(9.f, 4.5f, 1.f));
	...
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(x, 320.f, 0.f));
	//modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	//modelview = glm::rotate(modelview, currentTime / 1000.f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::rotate(modelview, 3.14f, glm::vec3(0.0f, 0.0f, 1.f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	...
	modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	modelview = glm::scale(modelview, glm::vec3(4.f, 1.f, 1.f));
	//modelview = glm::rotate(modelview, -currentTime / 1000.f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	texProgram.setUniformMatrix4f("modelview", modelview);
	texQuad[2]->render(texs[1]);

	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(510.f, 350.f, 0.f));
	modelview = glm::translate(modelview, glm::vec3(64.f, 64.f, 0.f));
	modelview = glm::scale(modelview, glm::vec3(4.f, 1.f, 1.f));
	//modelview = glm::rotate(modelview, -currentTime / 1000.f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	...
	text.render("Rebots: " + s, glm::vec2(10, CAMERA_HEIGHT - 450), 32, glm::vec4(1, 1, 1, 1));
	text.render(b, glm::vec2(x-20, CAMERA_HEIGHT - 200), 18, glm::vec4(1, 1, 1, 1));
}
